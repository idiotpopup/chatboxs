<?php
// Config file for EZChatBox
// please configure using the variables below

// EzChatBox location (no trailing slash)
...
// If EzChatBox is on a page of it's own this value
// must be Yes. If it is included then the value should be No.
// This decides whether to add HTML content at the top of
// the page.
$EZChat_html = "Yes";

// Chatbox refresh page settings
$EZChat_refresh = "Yes";
$EZChat_time = "30";
$EZChat_stringLength = "120";

// Upload page time to refresh
$EZChat_uptime = "3";

// Time stamp hour correction
$EZChat_timeChange = "0";

// Admin email (for banned users to plead case)
